...
<head>
	...
	<title>Surat Tugas Poliwangi</title>
	...
	<style>		
		...
		/* .gradient {
			background: linear-gradient(25deg, #86e5f1 10%, #ffffff 50%);
		} */
	</style>
...
<body class="leading-normal gradient tracking-normal text-gray-900" style="font-family: 'Source Sans Pro', sans-serif;">
...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg.svg');">
	...
	<div class="w-full container mx-auto p-6">
		...
		<div class="w-full flex items-center justify-between">
         ...
         <img src="{{ asset('public/assets/img/poltek2.png')}}" alt="logo" width="250" class="shadow-light mb-5 mt-2">
         <!-- POLIWANGI -->
			</a>
	...
	<!-- <p>
		<div class="w-full xl:w-2/5 py-2 overflow-y-hidden">
		<img class="w-2/5 mx-auto lg:mr-0 slide-in-bottom" src="bg-poliwangi.jpg">
		</div>
	</p> -->
  ...
  <!-- <div class="w-full xl:w-2/5 py-6 overflow-y-hidden">
    <img class="w-2/6 mx-auto lg:mr-0 slide-in-bottom" src="hero.png">
  </div> -->
		<!--Left Col-->
		<div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
			<h6 class="my-4 text-3xl md:text-4xl text-purple-900 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Aplikasi Administrasi Pelayanan Surat Tugas Politeknik Negeri Banyuwangi</h6>
			<p class="leading-normal text-base md:text-1xl mb-8 text-center md:text-left slide-in-bottom-subtitle">Jl. Raya Jember kilometer 13 Labanasem, Kabat, Banyuwangi, 68461 <br> Telepon / Faks : (0333) 636780 <br> Email : poliwangi@poliwangi.ac.id ; Website : http//www.poliwangi.ac.id</p>
		</div>
