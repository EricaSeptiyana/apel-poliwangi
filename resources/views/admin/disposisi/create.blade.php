                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="{{route('disposisi.store')}}" method="post" enctype="multipart/form-data" class="form=horizontal">
                                ...
                                <div class="col">
                                    ...
                                    <input type="hidden" id="text-input" name="id_surat" value="{{$surat->id}}" placeholder="Text" class="form-control">
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="text-input" class=" form-control-label">Tanggal Surat</label>
                                        </div>
                                        <div class="col-3 col-md-3">
                                            <input type="date" id="text-input" name="tanggal_permohonan"  value="{{$surat->tanggal_permohonan}}" placeholder="Text" class="form-control">
                                            <small class="form-text text-muted"></small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3 col-md-3">
                                            <input type="string" id="text-input" name="nomor_permohonan"  value="{{$surat->nomor_permohonan}}" class="form-control">
                                            <small class="form-text text-muted"></small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3 col-md-3">
                                            <input type="string" id="text-input" name="lampiran"  value="{{$surat->lampiran}}" class="form-control">
                                            <small class="form-text text-muted"></small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3 col-md-9">
                                            <input type="string" id="text-input" name="hal"  value="{{$surat->hal}}" class="form-control">
                                            <small class="form-text text-muted"></small>
                                        </div>
                                    </div>
                                            ...
                                            <select name='nama_penandatangan' class="form-control">
                                                @foreach($data_User as $User)
                                                    @if(!in_array($User->username, ['sekdir', 'kepegawaian', 'keuangan', 'superadmin', 'kajur']))
                                                        @if($surat->user->prodi_id == $User->prodi_id)
                                                <option value="{{$User->id}}" @if($User->id==$surat->nama_penandatangan)
                                                        selected
                                                        @endif
                                                        >
