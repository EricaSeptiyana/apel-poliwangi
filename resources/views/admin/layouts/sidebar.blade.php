<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <img alt="image" src="{{ asset('public/assets/img/poltek2.png')}}" width="50">   
            <!-- <a href="index.html">Stisla</a> -->
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="{{url('/admin/undangan')}}"><i class="fas fa-file-signature"></i> <span>Surat Undangan</span></a></li>
              <!-- <li class="active"><a class="nav-link" href="#"><i class="fas fa-chalkboard-teacher"></i> <span>Surat Keputusan</span></a></li> -->
              ...
              <!-- <li class="active"><a class="nav-link" href="blank.html"><i class="fas fa-database"></i> <span>Kelola User</span></a></li> -->
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span> Riwayat Surat Tugas</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="layout-default.html">Perorangan</a></li>
                  <li><a class="nav-link" href="layout-transparent.html">Kelompok</a></li>
              ...
              <!-- <li class="active"><a class="nav-link" href="blank.html"><i class="fas fa-chalkboard-teacher"></i> <span>Riwayat Surat Keputusan</span></a></li> -->
              <!-- <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-edit"></i> <span>Riwayat Penguji</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="components-article.html">Kerja Praktik</a></li>
                  <li><a class="nav-link beep beep-sidebar" href="components-avatar.html">Tugas Akhir</a></li>
              ...
              <!-- <li class="menu-header">Karya</li>
              <li class="active"><a class="nav-link" href="#"><i class="fas fa-file-signature"></i> <span>Penelitian</span></a></li>
              <li class="active"><a class="nav-link" href="#"><i class="fas fa-id-card"></i> <span>Pengabdian</span></a></li>
              <li class="active"><a class="nav-link" href="#"><i class="fas fa-atlas"></i> <span>Publikasi Ilmiah</span></a></li>
              <li class="active"><a class="nav-link" href="#"><i class="fas fa-chalkboard-teacher"></i> <span>Pelatihan / Workshop</span></a></li>
              <li class="active"><a class="nav-link" href="#"><i class="fas fa-archive"></i> <span>Penunjang</span></a></li> -->
              <!-- <li class="nav-item dropdown">
