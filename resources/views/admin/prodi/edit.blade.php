        ...
        <div class="card-body card-block">
            <div class="col-lg-12">
                <div class="card">
                  ...
                  @endif
                  <form action="{{route('prodi.update', $data->id)}}" method="post" enctype="multipart/form-data" class="form=horizontal">
                    @method('PATCH')
                    @csrf
                  <div class="container">
                        ...
                        <div class="col">
                          <!-- <div class="form-group"> -->
                            <div class="footer text-right">
                                ...
                                <a class="btn btn-danger text-white" href="{{route('prodi.index')}}" type="reset">Kembali</a>
                            </div>
                          <!-- </div> -->
                          <div class="form-group">
