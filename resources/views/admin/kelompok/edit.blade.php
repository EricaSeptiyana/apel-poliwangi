        ...
        <div class="card-body card-block">
            <div class="col-lg-12">
                <div class="card">
                  ...
                  @endif
                  <form action="{{route('kelompok.update', $data->id)}}" method="post" enctype="multipart/form-data" class="form=horizontal">
                    @method('PATCH')
                    @csrf
                  <div class="container">
                      <div class="row align-items-start">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="file-input" name="file_kelompok"  value="{{$data->file_kelompok}}" class="form-control-file"></div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                          ...
                          <!-- <div class="form-group">
                            <label>Pembuka</label>
                            <textarea type="textarea" name='txt_pembuka' style="height: 100px" value="Yang bertanda tangan dibawah ini, Direktur Politeknik Negeri Banyuwangi menugaskan Pegawai sebagai berikut:" class="form-control">Yang bertanda tangan dibawah ini, Direktur Politeknik Negeri Banyuwangi menugaskan Pegawai sebagai berikut:</textarea>
                          </div>
                          <div class="form-group">
                            <label>Jenis Kegiatan</label>
                            <input type="text" name='jenis_kegiatan' value="{{$data->jenis_kegiatan}}" class="form-control" placeholder="Jenis Kegiatan">
                          </div>
                          <div class="form-group">
                            <label>Jabatan</label>
                            <input type="text" name='txt_jabatan' value="{{$data->jabatan}}" class="form-control" placeholder="Agenda">
                          </div>
                          <div class="form-group">
                            <label>Waktu Mulai</label>
                            <input type="date" name='waktu_mulai' value="{{$data->waktu_mulai}}" class="form-control" placeholder="dd/mm/yyy">
                          </div>
                          <div class="form-group">
                            <label>Waktu Selesai</label>
                            <input type="date" name='waktu_selesai' value="{{$data->waktu_selesai}}" class="form-control" placeholder="dd/mm/yyy">
                          </div>
                          <div class="form-group">
                            <label>Tempat</label>
